...
export default function HalamanPersetujuanAdmin() {
  ...
  const { hariDalamBulan, hariAwalMinggu } =
    dapatkanHariDalamBulan(bulanSaatIni);
  ...
  const stringTanggalTerpilih = () => {
    ...
    return `${bulanSaatIni.getFullYear()}-${pad(
      bulanSaatIni.getMonth() + 1
    )}-${pad(tanggalTerpilih)}`;
  };
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm border border-slate-200 sticky top-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="font-bold text-slate-800">
                    {namaBulan[bulanSaatIni.getMonth()]}{" "}
                    {bulanSaatIni.getFullYear()}
                  </div>
                  <button
                        ...
                        {listReservasi.map((item) => (
                          ...
                          >
                            ...
                            <td className="px-6 py-4 text-slate-600">
                              {item.ruangan.jamMulai} -{" "}
                              {item.ruangan.jamSelesai}
                            </td>
            ...
            <div className="relative bg-white rounded-xl shadow-2xl max-w-lg w-full overflow-hidden transform transition-all scale-100">
              ...
              <div className="p-6 space-y-4">
                <div className="grid grid-cols-3 gap-y-4 text-sm">
                  ...
                  <div className="col-span-2">
                    <div className="font-semibold text-slate-900">
                      {selectedDetail.user.nama}
                    </div>
                    <div className="text-slate-500 text-xs">
                      {selectedDetail.user.nimNip}
                    </div>
                  </div>
                  ...
                  <div className="text-slate-500 font-medium self-center">
                    Dokumen
                  </div>
                  <div className="col-span-2">
                ...
                <div className="mt-8 pt-4 border-t border-slate-100 flex justify-end gap-3">
                  <button
                    onClick={() =>
                      handleStatusChange(selectedDetail.id, "Rejected")
                    }
                  ...
                  <button
                    onClick={() =>
                      handleStatusChange(selectedDetail.id, "Approved")
                    }
